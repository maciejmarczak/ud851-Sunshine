    ...
    public Loader<String[]> onCreateLoader(int i, @Nullable final Bundle bundle) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                final String location = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);

                if (location == null || "".equals(location)) {
                    return null;
                }

                final URL weatherRequestUrl = NetworkUtils.buildUrl(location);

                try {
                    final String jsonWeatherResponse = NetworkUtils
